...
package com.khue.composecanvas.chart.market_chart.scroll
...
class ChartScrollState : ScrollableState, ScrollListenerHost {
    ...
    private val _value: MutableState<Float> = mutableFloatStateOf(0f)
    private val _maxValue: MutableState<Float> = mutableFloatStateOf(0f)
